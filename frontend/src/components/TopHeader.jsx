        ...
        <header className="h-16 bg-slate-50 border-b border-gray-200 flex items-center justify-between px-8">
            ...
            <div className="flex items-center gap-6">
                ...
                >
                    ...
                    <div className="w-10 h-10 rounded-full bg-secondary/10 flex items-center justify-center text-secondary font-bold border-2 border-white shadow-sm group-hover:scale-105 transition-transform">
